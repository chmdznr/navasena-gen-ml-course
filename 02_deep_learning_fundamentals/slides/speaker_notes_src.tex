...
\textbf{Ucapkan:} "Panel bergaris putus-putus ini memang belum berisi angka, dan itu disengaja. Angka kecepatan hanya berarti bersama syarat pengukurannya, dan syaratnya baru ada setelah nb05 dijalankan di runtime hari ini. Jadi kita baca syaratnya dulu. Yang diukur nb05 ada empat: perkalian matriks; training CNN; inferensi satu batch gambar; dan engine TensorRT FP16 dibandingkan TensorFlow FP32 untuk model yang sama. Untuk yang terakhir, sebut apa adanya: itu perbandingan dua konfigurasi, karena engine dan presisinya berubah bersamaan, bukan pengaruh TensorRT saja. Ukurannya bergantung mode. Mode penuh: matriks 500 sampai 8.000, CNN tiga epoch pada 10.000 gambar CIFAR-10, inferensi 1.000 gambar. Mode QUICK memakai ukuran percobaan yang lebih kecil: matriks sampai 2.000, CNN satu epoch pada 2.000 gambar, inferensi 200 gambar. Pembandingnya CPU runtime ini lawan GPU yang benar-benar kita dapat --- catat nama perangkatnya dari keluaran notebook, jangan diasumsikan. Tiap sisi dijalankan lebih dulu sebagai warm-up sebelum diukur. Nanti setelah nb05 selesai, catat ukuran data, jumlah epoch, batch, perangkat, presisi, dan waktu yang terukur; hasilnya berlaku untuk konfigurasi dan kondisi runtime sesi ini. Tanya ke kelas setelah nb05 jalan: dari empat tugas itu, mana yang selisihnya paling kecil, dan apa yang membedakannya dari tiga yang lain?"\\[2pt]
