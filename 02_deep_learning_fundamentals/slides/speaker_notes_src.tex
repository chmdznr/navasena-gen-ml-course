...
\subsection*{\framebox{Slide 11/72}\quad Intuisi: Backprop: gradient dihitung dari output ke layer awal}
...
\subsection*{\framebox{Slide 36/72}\quad Bobot backbone tetap, head dilatih}
...
\subsection*{\framebox{Slide 44/72}\quad LSTM: tiga gerbang yang mengatur cell state}
...
\subsection*{\framebox{Slide 56/72}\quad Benchmark pada konfigurasi kelas}
...
\subsection*{\framebox{Slide 60/72}\quad Dua arah: memberi label, atau menghasilkan data}
