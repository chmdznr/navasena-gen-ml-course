...
Q = [
    ...
    ("LSTM karakter dijalankan dua kali dengan awalan sama: pada temperature 0,3 keluarannya mengulang kata yang sama, pada 1,2 banyak kata yang tidak ada dalam bahasa Indonesia. Apa yang diubah temperature?",
     ["Ketajaman sebaran probabilitas karakter: logit dibagi temperature sebelum softmax",
      "Jumlah karakter yang dihasilkan model dalam sekali pemanggilan fungsi pembangkit teks",
      "Learning rate yang dipakai saat model dilatih ulang pada korpus teks yang sama",
      "Panjang jendela konteks yang dibaca model sebelum menebak karakter berikutnya"], 0,
     "Temperature membagi logit sebelum softmax: nilai kecil menajamkan sebaran sehingga karakter paling mungkin hampir selalu terpilih (aman tapi berulang), nilai besar meratakannya sehingga karakter jarang ikut berpeluang (beragam tapi banyak kata rusak). Panjang keluaran, learning rate, dan panjang konteks diatur terpisah."),
