...
\textbf{Ucapkan:} "Slide ini sengaja tidak menyebut angka percepatan, dan itu bagian dari pesannya. Angka di panel kiri akan diisi dari hasil pengukuran nb10 di Colab dengan Tesla T4, jadi selama sesi ini belum menjalankan notebooknya, tidak ada rasio yang bisa saya sebutkan. Yang bisa disebut sekarang syarat pengukurannya, dan justru itu yang perlu kamu tiru. Tugasnya: Random Forest dua ratus pohon, KNN, K-Means, dan XGBoost. Datanya Covertype, lima ratus delapan puluh satu ribu baris; khusus KNN dipakai subset seratus ribu baris train supaya selnya tidak berjalan terlalu lama. Yang diukur: waktu \texttt{fit()} saja, dan diambil setelah warm-up. Perangkatnya satu GPU Tesla T4 di Google Colab, dibandingkan CPU pada runtime yang sama. Nanti setelah nb10 jalan, kita isi angkanya bersama dan lihat mana yang tidak sesuai dugaan."\\[2pt]
