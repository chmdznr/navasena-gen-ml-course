...
\begin{frame}{Benchmark: syarat pengukurannya disebut}
  ...
  \begin{columns}[T]
    \begin{column}{0.58\textwidth}
      \begin{center}
        \includegraphics[width=\textwidth, height=5.2cm, keepaspectratio]{figures/gpu_speedup.pdf}
      \end{center}
      {\scriptsize\color{nvgray}nb10 di Colab, 7 September 2026: Tesla T4 vs CPU runtime yang sama, setelah warm-up. Sumbu waktu skala log.}
    \end{column}
    \begin{column}{0.40\textwidth}
      \begin{itemize}\setlength\itemsep{0.15em}\small
        \item \textbf{Tugas}: RF 200 pohon, XGBoost, KNN, K-Means, PCA, regresi linear.
        \item \textbf{Data}: Covertype 581.012 baris; KNN 100.000; regresi linear 20.640.
        \item \textbf{Diukur}: waktu \texttt{fit()} saja.
        \item \textbf{Yang kalah}: PCA 0,2x, regresi linear 0,1x; kerjanya terlalu kecil untuk menutup overhead.
        \item \textbf{Skor}: XGBoost, KNN, PCA identik; RF 0,759 vs 0,783 dan K-Means bergeser, implementasi cuML berbeda.
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
