  ...
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      ...
      \begin{tikzpicture}[font=\scriptsize]
        ...
        \draw[nvlightgreen, line width=1.2pt, dashed] (3.12,-0.25) -- (3.12,1.75);
        \node[text=nvlightgreen, anchor=east, font=\tiny] at (2.95,1.78) {rata-rata semua tebakan};
...
\begin{frame}
  ...
  \vspace{0.6em}
  \begin{center}
    \includegraphics[width=\textwidth, height=3.1cm, keepaspectratio]{figures/boosting.pdf}
  \end{center}
  \vspace{0.6em}
  \nvbox{Intinya}{Modelnya dilatih berurutan, bukan bersamaan. Baris yang masih salah diberi
  bobot lebih besar untuk model berikutnya, sehingga tiap tambahan model menutup sisa kesalahan
  model sebelumnya.}
\end{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.5\textwidth}
      ...
      \begin{itemize}\setlength\itemsep{0.4em}
        ...
        \item Kalau kebutuhan bisnis butuh segmen yang lebih halus, K = 3--4 masih wajar;
              skornya turun sedikit, dan penurunan itu bagian dari keputusan.
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{DBSCAN: kelompok dari kepadatan, sisanya outlier}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.55\textwidth}
      \vspace{0.2em}
      \begin{itemize}\setlength\itemsep{0.3em}
        \item Baris yang punya paling sedikit \texttt{min\_samples} tetangga dalam radius
              \texttt{eps} menjadi inti kelompok; tetangganya ikut bergabung.
...
% FRAME 79 — cuML
% ----------------------------------------------------------
\begin{frame}[fragile]{cuML: yang berubah hanya barisnya import}
  \vspace{0.3em}
...
\begin{frame}{Benchmark: syarat pengukurannya disebut}
  ...
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      ...
      \end{center}
      \vspace{0.1em}
      {\scriptsize\color{nvgray}Angka diisi dari hasil Colab T4 di nb10.}
    \end{column}
    \begin{column}{0.47\textwidth}
      \vspace{0.2em}
      \begin{itemize}\setlength\itemsep{0.35em}
        \item \textbf{Tugas}: Random Forest 200 pohon, KNN, K-Means, dan XGBoost.
        \item \textbf{Data}: Covertype, 581.012 baris.
...
\begin{frame}{Ringkasan Act 7}
  ...
  \begin{itemize}\setlength\itemsep{0.55em}
    ...
    \item Perubahan kodenya kecil: satu baris import untuk cuML, satu argumen \texttt{device}
          untuk XGBoost.
    \item Ada keadaan di mana CPU lebih cepat, dan itu bukan kesalahan pengukuran: data kecil,
