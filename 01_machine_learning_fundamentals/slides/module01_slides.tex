  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \begin{itemize}\setlength\itemsep{0.2em}
        ...
        \item \textbf{PCA dan regresi linear kalah} (0,2x dan 0,1x): pekerjaannya terlalu kecil untuk menutup overhead.
        \item \textbf{Akurasi}: XGBoost, KNN, PCA identik; RF cuML 0,759 vs 0,783 dan K-Means berbeda, implementasinya lain.
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
