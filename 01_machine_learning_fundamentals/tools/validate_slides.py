#!/usr/bin/env python3
"""Gate deck Modul 01: invarian sumber .tex + hasil build. Exit 0 = lulus.
...
TEX, PDF, LOG = ROOT / "module01_slides.tex", ROOT / "module01_slides.pdf", ROOT / "module01_slides.log"
...
if n_int < 10:
    (warns if PARTIAL else errs).append(f"\\intuisi hanya {n_int} (mau ≥ 10)")
