...
Q = [
    ...
    ("Seorang peserta mengukur akurasi model pada data yang sama dengan data latihnya, hasilnya 99%. Apa masalahnya?",
    ...
    ("Kapan scaling (menyamakan rentang nilai feature) benar-benar mengubah hasil model?",
    ...
    ("Model memprediksi 'tidak beli' untuk semua orang dan akurasinya 89%. Apa yang bisa disimpulkan?",
     ["Model sudah bagus karena akurasi di atas 80% umumnya dianggap layak untuk produksi",
      ...
      "Model terlalu rumit dan perlu disederhanakan supaya tidak menghafal data latihnya"], 1,
    ...
    ("Nilai R² sebuah model regresi adalah 0. Apa artinya?",
     ...
     "R² membandingkan error model dengan error prediksi rata-rata: 1 = sempurna, 0 = sama dengan rata-rata, negatif = lebih buruk."),
    ...
    ("Dalam bootstrap yang dipakai bagging, data train baru dibuat dengan cara apa?",
