...
\begin{frame}{Embeddings: Makna Jadi Angka}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \begin{center}\includegraphics[width=0.72\linewidth]{figures/embedding_space.pdf}\end{center}
    \end{column}
  \end{columns}
  ...
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      ...
      \begin{itemize}\footnotesize
        ...
        \item Sinonim \& parafrase terlewat (tak ketemu)
      \end{itemize}
      \vspace{0.3em}
...
\begin{frame}{Dampak Reranking}
  ...
  \begin{columns}[T]
    ...
    \end{column}
    \begin{column}{0.56\textwidth}
      \begin{center}\includegraphics[width=\linewidth]{figures/rerank_lift.pdf}\end{center}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Trade-off: Recall vs Kecepatan}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.58\textwidth}
      \begin{center}\includegraphics[width=\linewidth]{figures/faiss_tradeoff.pdf}\end{center}
    \end{column}
  \end{columns}
\end{frame}
