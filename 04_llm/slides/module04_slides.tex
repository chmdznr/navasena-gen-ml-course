  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{itemize}
        ...
        \item Kunci LLM paham konteks kalimat panjang
      \end{itemize}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{center}
  ...
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        ...
        \item Untuk sentimen nyata: pakai model \emph{fine-tuned} (mis. \textbf{distilbert-sst-2})
      \end{itemize}
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{center}
  ...
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        ...
        \item \texttt{float16} $\to$ hemat memori GPU separuhnya
