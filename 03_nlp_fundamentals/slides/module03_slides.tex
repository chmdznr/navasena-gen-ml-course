  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        ...
        \item[\textcolor{nvgreen}{\checkmark}] Lebih akurat dari \emph{stemming}
        \item[\textcolor{nvgreen}{\checkmark}] Sastrawi: \texttt{Stemmer.stem()}
      \end{itemize}
      \vspace{0.3em}
