  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \begin{itemize}
        ...
        \item Bahasa Indonesia: lebih challenging karena imbuhan
...
\begin{frame}{Named Entity Recognition (NER)}
  ...
  \resizebox{\linewidth}{!}{%
  \begin{tikzpicture}
    \node[text=nvwhite, font=\small] at (0,2.5) {"Achmad Zaenuri bekerja di Navasena di Jakarta sejak 2024."};
    \node[draw=nvgreen, fill=nvcard, rounded corners=3pt,
          text=nvwhite, font=\small, minimum width=2.5cm] (p) at (-3,0.5) {Achmad Zaenuri};
    \node[draw=nvblue, fill=nvcard, rounded corners=3pt,
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        \footnotesize
        \item \texttt{nltk} — text processing dasar
        \item \texttt{Sastrawi} — stemming Indonesia
        \item \texttt{nlp-id} — tokenizer \& POS
...
\begin{frame}{Lanjutan: Modul 04 -- LLM}
  \begin{itemize}
    ...
    \item[\textcolor{nvgreen}{\checkmark}] Module 06: NVIDIA ecosystem (TensorRT, NeMo, RAG)
  \end{itemize}
  \vspace{0.8em}
  \begin{center}
