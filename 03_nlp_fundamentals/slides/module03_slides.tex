...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Besar kemenangannya ikut bergantung beban: SmSA yang kecil hanya 3,2x, bigram di 237 ribu paragraf 81x
  \end{itemize}
\end{frame}
...
\begin{frame}{Seberapa Cepat? (Colab T4, 237 ribu paragraf Wikipedia ID)}
  \begin{center}
    \includegraphics[width=0.84\textwidth]{figures/rapids_speedup.pdf}
  \end{center}
  \footnotesize\textcolor{nvgray}{Run 2026-09-08, Colab T4, cuDF/cuML 26.02. Selisihnya berbeda per operasi; angka di mesinmu pun akan berbeda.}
\end{frame}
...
\begin{frame}{Dari Lab ke Produksi: NeMo Curator}
  ...
  \begin{tabular}{@{}p{0.44\linewidth}p{0.48\linewidth}@{}}
    \toprule
    \rowcolor{nvcard!50}
    \textbf{Hari ini (1 T4, 237 ribu paragraf)} & \textbf{Produksi (ratusan GPU, miliaran dokumen)} \\
    \midrule
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        ...
        \item Babak 2 --- nvtext pada 237 ribu paragraf Wikipedia
